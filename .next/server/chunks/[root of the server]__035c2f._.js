...
"[project]/app/services/users.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/app/lib/db.ts [app-route] (ecmascript)");
...
const findUserFromCustomerId = async (stripeCustomerId)=>{
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getServerSession"])().then((res)=>{
        console.log("AUTH SESSION SERVER", res);
    });
    if (typeof stripeCustomerId !== "string") {
        return null;
    }
    return __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.findFirst({
        where: {
            stripeCustomerId
        }
    });
...
"[project]/app/lib/server.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/app/lib/server.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$users$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/app/services/users.ts [app-route] (ecmascript)");
...
const POST = async (req)=>{
    ...
    switch(body.type){
        case "checkout.session.completed":
            ...
            const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$users$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["findUserByEmail"])(checkoutSession?.customer_email);
            // const user = await get(`/api/user?id=${authSession?.user.keyCloakUserId}`)
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["patch"])(`/api/user?id=${user?.id}`, {
        ...
        case "customer.subscription.created":
            const subscriptionCreated = body.data.object;
            break;
        ...
        case "customer.subscription.deleted":
            ...
            break;
        case "invoice.paid":
            const paidInvoice = body.data.object;
            // Handle paid invoice
            console.log("INVOICE PAID");
            break;
        case "invoice.payment_succeeded":
            const paymentSucceed = body.data.object;
            // Handle paid invoice
            console.log("INVOICE PAID");
            break;
        case "invoice.payment_failed":
            const failedInvoice = body.data.object;
            break;
        default:
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__035c2f._.js.map