...
"[externals]/ [external] (@prisma/client/runtime/library, cjs)": (function(__turbopack_context__) {

var { r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, b: __turbopack_worker_blob_url__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__, m: module, e: exports, t: require } = __turbopack_context__;
{
const mod = __turbopack_external_require__("@prisma/client/runtime/library");

module.exports = mod;
}}),
"[project]/app/api/article/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$2840$prisma$2f$client$2f$runtime$2f$library$2c$__cjs$29$__ = __turbopack_import__("[externals]/ [external] (@prisma/client/runtime/library, cjs)");
...
async function POST(req) {
    ...
    try {
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].article.create({
            data: data
        });
        ...
        if (error instanceof __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$2840$prisma$2f$client$2f$runtime$2f$library$2c$__cjs$29$__["PrismaClientKnownRequestError"]) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: error.code
            }, {
                status: 500
...
async function GET() {
    const articles = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].article.findMany({
        select: {
            id: true
        }
    });
...
async function PATCH(req) {
    ...
    const data = await req.json();
    await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].article.update({
        where: {
            id: articleId
        },
        data: {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__d9be8e._.js.map