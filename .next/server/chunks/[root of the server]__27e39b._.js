...
const POST = async (req)=>{
    ...
    switch(body.type){
        case "checkout.session.completed":
            ...
            const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$users$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["findUserFromCustomerId"])(stripeCustomerId);
            if (!user) {
                const authSession = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$react$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSession"])();
                const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["patch"])(`/api/user?id=${authSession?.user?.id}`, {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__27e39b._.js.map