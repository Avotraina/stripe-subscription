...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$providers$2f$keycloak$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/next-auth/providers/keycloak.js [app-route] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$stripe$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/app/lib/stripe.ts [app-route] (ecmascript)");
;
;
;
;
;
;
const keycloak = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$providers$2f$keycloak$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
...
const authOptions = {
    ...
    callbacks: {
        async signIn ({ user, account, profile }) {
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.upsert({
                    where: {
                        email: profile?.email
                    },
                    update: {
                ...
                const logPath = __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), "debug.log");
                __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].appendFileSync(logPath, `${new Date().toISOString()} - ${JSON.stringify(error)}\n`);
                return false;
            }
        },
    ...
    events: {
        ...
        createUser: async (message)=>{
            ...
            //     return;
            // }
            const stripeCustomer = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$stripe$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["stripe"].customers.create({
                email,
                name: name ?? undefined
            });
            console.log("STRIPE CUSTOMER", stripeCustomer);
            const logPath = __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), "debug.log");
            __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].appendFileSync(logPath, `${new Date().toISOString()} - ${JSON.stringify(stripeCustomer)}\n`);
            await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.update({
                where: {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__8cc843._.js.map