...
const POST = async (req)=>{
    ...
    switch(body.type){
        case "checkout.session.completed":
            ...
            console.log("SESSION COMPLETED", checkoutSession);
            const user = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.update({
                where: {
        ...
        case "customer.subscription.deleted":
            ...
            const userForSubDeletion = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$users$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["findUserFromCustomerId"])(subscriptionDeleted.customer);
            await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.update({
                where: {
                    email: userForSubDeletion?.email
                },
                data: {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__f7e3d7._.js.map